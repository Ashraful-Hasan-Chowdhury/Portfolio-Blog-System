      ...
      <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
        ...
        <li class="nav-item has-treeview menu-open">
          ...
          <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href={{route('post.index')}} class="nav-link @yield('postActive')">
            ...
            <li class="nav-item">
              <a href={{route('category.index')}} class="nav-link @yield('categoryActive')">
                <i class="fas fa-folder-open nav-icon"></i>
                <p>Categories</p>
              </a>
            </li>
            <li class="nav-item">
              <a href={{route('tag.index')}} class="nav-link @yield('tagActive')">
